...
<head>
    ...
    <title>Search Task By Date - My Tasks</title>
...
<body>
    ...
    <div class="container">
        <h1 class="display-1 my-5 text-primary">Search Task By Date</h1>
        <form class="row mb-3" action="../tasks/search_by_date.php" method="get">
        <div class="col-10">
            <input type="date" name="date" id="date" value="<?php if(isset($_GET["date"])){echo $_GET["date"];} ?>" class="form-control"> 
        </div>
        <div class="col-2">
            <button type="submit" class="btn btn-primary">Search</button>
            <a href="../tasks/search_by_date.php" class="btn btn-secondary">Reset</a>
        </div>
        </form>
        <div class="row">
