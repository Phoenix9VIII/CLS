...
$user = mysqli_fetch_assoc($users_list);
...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Task Flow | Responsive Bootstrap 4 Admin Dashboard Template</title>
      ...
      <div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center">
              <a href="../backend/index.html" class="header-logo">
                  ...
                  <h3 class="logo-title light-logo">Task Flow</h3>
              </a>
          ...
          <div class="iq-navbar-custom">
              <nav class="navbar navbar-expand-lg navbar-light p-0">
                  <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                      ...
                      <a href="../backend/index.html" class="header-logo">
                          <h4 class="logo-title text-uppercase">Task Flow</h4>
                              ...
                              <li class="nav-item nav-icon dropdown caption-content">
                                  <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center" id="dropdownMenuButton4"
                                      ...
                                      <div class="caption ml-3">
                                          <h6 class="mb-0 line-height">Nour<i class="las la-angle-down ml-2"></i></h6>
                                      </div>
                                  </a>                            
                  ...
                  <table id="user-list-table" class="table table-striped dataTable mt-4" role="grid"
                    ...
                    <?php
                        ...
                        <tr>
                           ...
                           <td><?php echo $user["address"] ?><span class="badge bg-primary"></span></td>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 text-right">
                    <span class="mr-1"><script>document.write(new Date().getFullYear())</script>©</span> <a href="#" class="">Task Flow</a>.
                </div>
            </div>
        </div>
    </footer>
