...
if (isset($_POST["name"]) && $_POST["name"] != "" && $_POST["email"] != "" && $_POST["password"] != "" && $_POST["phone"] != "" && $_POST["address"] != "" && $_POST["city_id"] != "") {
    $name = $_POST["name"];
    $email = $_POST["email"];
    ...
    // $x = mysqli_fetch_assoc($result_set);
...
<body>
    <div class="container">
        ...
        <form class="row" action=" ../auth/register.php" method="post">
            <div class="col-12">
