...
if (isset($_GET["term"])) {
    $term = $_GET["term"];
    $sql = "SELECT * FROM tasks WHERE name LIKE '%$term%' OR date = '$term' OR due_date = '$term' OR user_id = '$term' OR category_id = '$term'";
} else {
...
<head>
    ...
    <title>Search All Tasks - My Tasks</title>
...
<body>
    ...
    <div class="container">
        <h1 class="display-1 my-5 text-primary">Search All Tasks</h1>
