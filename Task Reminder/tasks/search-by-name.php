...
<head>
    ...
    <title>Search Tasks By Name - My Tasks</title>
...
<body>
    ...
    <div class="container">
        <h1 class="display-1 my-5 text-primary">Search Tasks By Name</h1>
        <form class="row mb-3" action="../tasks/search-by-name.php" method="get">
            <div class="col-10">
