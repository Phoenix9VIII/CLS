...
if(isset($_GET["date"])){
    $date = $_GET["date"];
    $sql = "SELECT * FROM tasks WHERE due_date = '$date'";
} else {
...
<head>
    ...
    <title>Search Tasks By Date - My Tasks</title>
...
<body>
    ...
    <div class="container">
        <h1 class="display-1 my-5 text-primary">Search Tasks By Date</h1>        
        <form class="row mb-3" action="../tasks/search-by-date.php" method="get">
            <div class="col-10">
                <input type="date" value="<?php if(isset($_GET["date"])){ echo $_GET["date"]; } ?>" name="date" id="date" class="form-control">
            </div>
            <div class="col-2">
                <button type="submit" class="btn btn-primary">Search</button>
                <a href="../tasks/search-by-date.php" class="btn btn-secondary">Reset</a>
            </div>
        </form>        
        <div class="row">
