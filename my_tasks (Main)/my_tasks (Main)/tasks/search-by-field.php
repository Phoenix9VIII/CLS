...
<head>
    ...
    <title>Search Tasks By Field - My Tasks</title>
...
<body>
    ...
    <div class="container">
        <h1 class="display-1 my-5 text-primary">Search Tasks By Field</h1>        
        <form class="row mb-3" action="../tasks/search-by-field.php" method="get">
            <div class="col-6">
            ...
            <div class="col-4">
                <select name="field" id="field" class="form-select">
                    ...
                    <option value="user_id">Task User</option>
                    <option value="category_id">Task Category</option>
                </select>
            </div>
            <div class="col-2">
