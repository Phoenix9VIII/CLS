...
if(isset($_GET["term"])){
    $term = $_GET["term"];
    $sql = "SELECT * FROM users WHERE name LIKE '%$term%' OR email LIKE '%$term%' OR address LIKE '%$term%' OR phone = '$term' OR city_id = '$term'";
} else {
...
<head>
    ...
    <title>Search All Users - My Tasks</title>
...
<body>
    ...
    <div class="container">
        <h1 class="display-1 my-5 text-primary">Search All Users</h1>        
        <form class="row mb-3" action="../users/search-all.php" method="get">
            <div class="col-10">
                <input type="text" value="<?php if(isset($_GET["term"])){ echo $_GET["term"]; } ?>" name="term" id="term" class="form-control">
            </div>
            <div class="col-2">
                <button type="submit" class="btn btn-primary">Search</button>
                <a href="../users/search-all.php" class="btn btn-secondary">Reset</a>
            </div>
        </form>        
        <div class="row">
