...
if(isset($_GET["term"])){
    ...
    if($field == "name"){
        ...
        $sql = "SELECT * FROM users WHERE phone='$term'";
    } elseif($field == "address"){
        $sql = "SELECT * FROM users WHERE address='$term'";
    } elseif($field == "city_id"){
        $sql = "SELECT * FROM users WHERE city_id='$term'";
    }
...
<head>
    ...
    <title>Search Users By Field - My Tasks</title>
...
<body>
    ...
    <div class="container">
        <h1 class="display-1 my-5 text-primary">Search Users By Field</h1>        
        <form class="row mb-3" action="../users/search-by-field.php" method="get">
            <div class="col-6">
                <input type="text" value="<?php if(isset($_GET["term"])){ echo $_GET["term"]; } ?>" name="term" id="term" class="form-control">
            </div>
            <div class="col-4">
                <select name="field" id="field" class="form-select">
                    <option value="name">Userame</option>
            ...
            <div class="col-2">
                ...
                <a href="../users/search-by-field.php" class="btn btn-secondary">Reset</a>
            </div>
        </form>        
        <div class="row">
