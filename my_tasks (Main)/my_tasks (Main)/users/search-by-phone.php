...
<head>
    ...
    <title>Search Users By Phone - My Tasks</title>
...
<body>
    ...
    <div class="container">
        <h1 class="display-1 my-5 text-primary">Search Users By Phone</h1>        
        <form class="row mb-3" action="../users/search-by-phone.php" method="get">
            <div class="col-10">
                <input type="phone" value="<?php if(isset($_GET["phone"])){ echo $_GET["phone"]; } ?>" name="phone" id="phone" class="form-control">
            </div>
            <div class="col-2">
                <button type="submit" class="btn btn-primary">Search</button>
                <a href="../tasks/search-by-phone.php" class="btn btn-secondary">Reset</a>
            </div>
        </form>        
        <div class="row">
